...
export default function Page({
  ...
  return (
    <section
      id={id}
      className="flex h-screen snap-start snap-always flex-col px-[var(--spacing-7)] pt-[calc(52px+var(--spacing-5))] pb-[var(--spacing-6)] max-lg:h-auto max-lg:min-h-screen max-lg:px-[var(--spacing-4)] max-lg:pt-[88px]"
    >
      <motion.div
