...
$cmd = @{
    ...
    eval    = "python -m rakshak.eval.harness --seed $Seed; python -m rakshak.eval.verdict --seed $Seed; python -m rakshak.eval.ablations --seed $Seed; python -m rakshak.eval.lag_probe --seed $Seed; python -m rakshak.explain.reasons --seed $Seed; python -m rakshak.eval.baf --seed $Seed"
